 ...
 * expose the NCT5104D SuperIO and some of its functionality.
 *
 ...
 * 0xb HWM		Not implemented
 * 0xc PECI&SST		Not implemented
 * 0x10 UARTC		Implemented
 * 0x11 UARTD		Implemented
 *
 ...
 * NCT5104D_SHOW_UARTA	If defined, UARTA will be exposed.
 * NCT5104D_SHOW_UARTB	If defined, UARTB will be exposed.
 * NCT5104D_SHOW_UARTC	If defined, UARTC will be exposed.
 * NCT5104D_SHOW_UARTD	If defined, UARTD will be exposed.
 */

#undef SUPERIO_CHIP_NAME
#define SUPERIO_CHIP_NAME NCT5104D
...
#ifdef NCT5104D_SHOW_UARTC
	#undef SUPERIO_UART_LDN
	#undef SUPERIO_UART_DDN
	#undef SUPERIO_UART_PM_REG
	#undef SUPERIO_UART_PM_VAL
	#undef SUPERIO_UART_PM_LDN
	#define SUPERIO_UART_LDN 0x10
	#define SUPERIO_UART_PM_VAL 0
	#define SUPERIO_UART_PM_LDN PNP_NO_LDN_CHANGE
	#include <superio/acpi/pnp_uart.asl>
#endif

#ifdef NCT5104D_SHOW_UARTD
	#undef SUPERIO_UART_LDN
	#undef SUPERIO_UART_DDN
	#undef SUPERIO_UART_PM_REG
	#undef SUPERIO_UART_PM_VAL
	#undef SUPERIO_UART_PM_LDN
	#define SUPERIO_UART_LDN 0x11
	#define SUPERIO_UART_PM_VAL 0
	#define SUPERIO_UART_PM_LDN PNP_NO_LDN_CHANGE
	#include <superio/acpi/pnp_uart.asl>
#endif
