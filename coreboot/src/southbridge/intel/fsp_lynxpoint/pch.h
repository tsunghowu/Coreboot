 ...
 */
#define SMBUS_IO_BASE		0xEFA0		//Compatiable with Intel FSP.
...
int smbus_byte_read(unsigned char device, unsigned char address, unsigned char *pByte);
int smbus_block_read(unsigned char device, unsigned char address, unsigned char *pBuffer, unsigned char *length);
