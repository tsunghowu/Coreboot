...
//<CHW+>	usb_ehci_sleep_prepare(PCH_EHCI1_DEV, slp_typ);
//<CHW+>	usb_ehci_sleep_prepare(PCH_EHCI2_DEV, slp_typ);
#endif
//<CHW+>	usb_xhci_sleep_prepare(PCH_XHCI_DEV, slp_typ);
