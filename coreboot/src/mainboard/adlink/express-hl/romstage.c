...
const struct rcba_config_instruction rcba_config[] = {
	...
	RCBA_SET_REG_32(D31IP, (INTC << D31IP_TTIP) | (INTB << D31IP_SIP2) |
			(INTC << D31IP_SMIP) | (INTB << D31IP_SIP)),
	RCBA_SET_REG_32(D29IP, (INTA << D29IP_E1P)),
	RCBA_SET_REG_32(D28IP, (INTD << D28IP_P8IP) | (INTC << D28IP_P7IP) |
	...
	RCBA_SET_REG_32(D25IP, (INTA << D25IP_LIP)),
	RCBA_SET_REG_32(D22IP, (INTB << D22IP_KTIP) | (INTC << D22IP_IDERIP) |
		(INTB << D22IP_MEI2IP) | (INTA << D22IP_MEI1IP)),
	RCBA_SET_REG_32(D20IP, (INTA << D20IP_XHCI)),

	/* Device interrupt route registers */
	RCBA_SET_REG_32(D31IR, DIR_ROUTE(PIRQA, PIRQD, PIRQC, PIRQA)),
	RCBA_SET_REG_32(D29IR, DIR_ROUTE(PIRQH, PIRQD, PIRQA, PIRQC)),
	RCBA_SET_REG_32(D28IR, DIR_ROUTE(PIRQA, PIRQB, PIRQC, PIRQD)),
	RCBA_SET_REG_32(D27IR, DIR_ROUTE(PIRQG, PIRQB, PIRQC, PIRQD)),
	RCBA_SET_REG_32(D26IR, DIR_ROUTE(PIRQF, PIRQA, PIRQC, PIRQD)),
	RCBA_SET_REG_32(D25IR, DIR_ROUTE(PIRQE, PIRQF, PIRQG, PIRQH)),
	RCBA_SET_REG_32(D22IR, DIR_ROUTE(PIRQA, PIRQD, PIRQC, PIRQB)),
	RCBA_SET_REG_32(D20IR, DIR_ROUTE(PIRQD, PIRQE, PIRQF, PIRQG)),
