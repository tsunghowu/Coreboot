...
#include <reset.h>
//<CHW+>#include "superio/smsc/sio1007/chip.h"
#include "superio/winbond/common/winbond.h"		//<CHW+>
...
#define SERIAL_DEV PNP_DEV(0x3f8, W83627DHG_SP1)
...
printk(BIOS_DEBUG, "main(FSP_INFO_HEADER *fsp_info_header)\n");
...
printk(BIOS_DEBUG, "0 Back from sandybridge_early_initialization()\n");
printk(BIOS_DEBUG, "1 Back from sandybridge_early_initialization()\n");
printk(BIOS_DEBUG, "2 Back from sandybridge_early_initialization()\n");

	post_code(0x44);
	/* Wait for ME to be ready */
//printk(BIOS_DEBUG, "%s %d\n", __FUNCTION__, __LINE__ );
	intel_early_me_status();
	printk(BIOS_DEBUG, "A Back from sandybridge_early_initialization()\n");
	intel_early_me_init();
	printk(BIOS_DEBUG, "B Back from sandybridge_early_initialization()\n");
	intel_early_me_uma_size();
	printk(BIOS_DEBUG, "C Back from sandybridge_early_initialization()\n");
